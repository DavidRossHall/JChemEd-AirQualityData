...
#file <- read.csv("Toronto_60410_2018/Toronto_60410_2018_Day10to16.csv", header = TRUE)
```
```{r, echo = FALSE}
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, error = FALSE, fig.height = 1.25, fig.cap= "Time series of pollutant concentration. There shouldn't be a linear regression on this plot, if students have done so please note it."}
...
```{r, echo = FALSE, warning = FALSE, message = FALSE, error = FALSE, fig.cap= "Correlation plot of O3 vs. NO2; the equation of the line is displayed in the lower left corner.", fig.height = 2, fig.width=4}
